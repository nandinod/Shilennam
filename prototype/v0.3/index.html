...
<body>
	...
	<div class="row-gov-party">
		<div class="container">
			<h3 class="text-center">Улс төрийн намууд</h3>
			<div class="row">
				<div class="col-sm-3">
					<div class="well well-md">
						<img class="img-responsive align-center" src="res/party/democratic.png" alt="Democratic Party">
						<h4><a href="#">Ардчилсан нам</a></h4>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="well well-md">
						<img class="img-responsive align-center" src="res/party/peoples.png" alt="Democratic Party">
						<h4><a href="#">Ардын нам</a></h4>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="well well-md">
						<img class="img-responsive align-center" src="res/party/civil_green.png" alt="Democratic Party">
						<h4><a href="#">Иргэний ногоон нам</a></h4>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="well well-md">
